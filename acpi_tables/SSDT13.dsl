 ...
 *
 * Disassembly of SSDT13.bin, Wed Aug 14 20:55:56 2024
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00000608 (1544)
 *     Revision         0x02
 *     Checksum         0x10
 *     OEM ID           "AMD"
 *     OEM Table ID     "TOUCHPAD"
 *     OEM Revision     0x00000001 (1)
 *     Compiler ID      "INTL"
 *     Compiler Version 0x20220331 (539099953)
 */
DefinitionBlock ("", "SSDT", 2, "AMD", "TOUCHPAD", 0x00000001)
{
    ...
    Scope (\_SB.I2CB)
    {
        Device (TPDD)
        {
            ...
            {
                CreateWordField (^RBUF, \_SB.I2CB.TPDD._Y00._ADR, TTSL)  // _ADR: Address
                CreateDWordField (^RBUF, \_SB.I2CB.TPDD._Y00._SPE, TTSP)  // _SPE: Speed
