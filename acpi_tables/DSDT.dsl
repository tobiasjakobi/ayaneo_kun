 ...
 *
 * Disassembly of DSDT.bin, Wed Aug 14 20:55:56 2024
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00008B6F (35695)
 *     Revision         0x02
 *     Checksum         0x4D
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I "
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0x96905000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0x96909000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD310510)
    Name (FTPM, 0xFD310510)
    Name (PPIM, 0x97403D18)
    Name (PPIL, 0x1C)
    Name (TPMF, One)
    Name (PPIV, One)
    Name (AMDT, 0x01)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0x97403D98, 0x0D)
            ...
            Device (PRT1)
            {
                ...
                Name (PLD1, Package (0x01)
                {
                    Buffer (0x14)
                    {
                        ...
                        /* 0008 */  0x69, 0x10, 0x08, 0x00, 0x03, 0x00, 0x00, 0x00,  // i.......
    ...
    Scope (_SB.I2CB)
    {
        Device (AWDZ)
        {
            Name (_HID, "AWDZ8830")  // _HID: Hardware ID
            Name (_CID, "AWDZ8830")  // _CID: Compatible ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (BUF1, ResourceTemplate ()
            ...
            Method (_DSM, 4, Serialized)  // _DSM: Device-Specific Method
            {
                If ((Arg0 == ToUUID ("1cc539cd-5a26-4288-a572-25c5744ebf1b")))
                {
                    If ((Arg2 == Zero))
                    {
                        Return (Buffer (0x04)
                        {
                             0x0B, 0x58, 0x0B, 0x5B                           // .X.[
                        })
                    }
