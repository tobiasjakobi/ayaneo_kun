 ...
 *
 * Disassembly of SSDT6.bin, Wed Aug 14 20:55:56 2024
 *
 ...
 */
DefinitionBlock ("", "SSDT", 2, "AMD", "CPMEC", 0x00000001)
{
    ...
    {
        Return (\_SB.PCI0.SBRG.EC0.M040 (Arg0))
    }

    Method (M041, 2, Serialized)
    {
        \_SB.PCI0.SBRG.EC0.M041 (Arg0, Arg1)
    }

    Method (M31A, 1, Serialized)
    {
        Return (\_SB.PCI0.SBRG.EC0.M31A (Arg0))
    }

    Method (M319, 2, Serialized)
    {
        \_SB.PCI0.SBRG.EC0.M319 (Arg0, Arg1)
    }

    Method (M31B, 4, Serialized)
    {
        \_SB.PCI0.SBRG.EC0.M31B (Arg0, Arg1, Arg2, Arg3)
    }
    ...
    Scope (\_SB.PCI0.SBRG.EC0)
    {
            ...
            If (CondRefOf (\_SB.PCI0.SBRG.EC0.OKEC))
            {
                If ((\_SB.PCI0.SBRG.EC0.OKEC == One))
                {
                    If (CondRefOf (Z009))
                    {
                        ...
                        Local1 = VARR /* \_SB_.PCI0.SBRG.EC0_.M040.VARR */
                        Release (Z009)
                    }
                }
            }
        ...
        Method (M31A, 1, Serialized)
        {
            ...
            Local1 = VARO /* \_SB_.PCI0.SBRG.EC0_.M31A.VARO */
            Return (Local1)
        }
